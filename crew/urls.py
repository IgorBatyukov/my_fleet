...
urlpatterns = [
    ...
    path('crew/<int:pk>/rank/<int:rank_id>/matrix/',
         views.CrewCertificationMatrixView.as_view(),
         name='crew_certification_matrix'),
    ...
    path('crew/<int:crew_id>/certificate/<int:pk>/delete/',
         views.CrewCertificateDelete.as_view(),
         name='certificate_delete'),
    path('crew/<int:crew_id>/certificate/add/', views.CrewCertificateAdd.as_view(), name='certificate_add'),
    path('crew/<int:crew_id>/certificate/<int:cert_id>/add/',
         views.CrewCertificateAddSpecificView.as_view(),
         name='certificate_add_specific'),
    ...
    path('crewchange/vessel/<int:vessel_id>/add/',
         views.CrewChangeAddOnVessel.as_view(),
         name='crew_change_add_on_vessel'),
